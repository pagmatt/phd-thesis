...
\begin{figure}[t!]
    ...
    \includegraphics[width=0.75\linewidth]{Figures/CentralResourceManagement/architecture_full.png}}\hfill
    \centering
    \subfloat[High level diagram of the proposed \gls{mwm}-based framework.\label{Fig:Diagram}]{
    \includegraphics[width=0.75\linewidth]{Figures/CentralResourceManagement/FlowChart_IAB.png}}
...
\begin{figure}[t!]
	\centering
  	...
  	\includegraphics[width=0.6\linewidth]{Figures/CentralResourceManagement/Phase0.png}
    }\hfill
  	\subfloat[Computation of the \gls{mwm} and of the corresponding scheduling indications.\label{Fig:Phase2}]{
  	\includegraphics[width=0.6\linewidth]{Figures/CentralResourceManagement/Phase2.png}
    }
