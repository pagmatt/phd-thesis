...
% externalize tikz plots - it should speed up compilation time
...
% 	\tikzexternalize[prefix=Figures/IrsSimulation/]
% \fi
...
% \begin{aligned}
% 	y_{D} = \,\, & \bm{w}_{\textrm D}^{\textrm T} \bm{H}_{\textrm {RD}} \bm{\Phi} \bm{H}_{\textrm {SR}} \bm{w}_{\textrm S} x_{S} + \sum_{\hat{I} \in  I_{\textrm{LOS}}} \bm{w}_{\mathrm D}^{T} \bm{H}_{\mathrm \hat{I} D}  \bm{w}_{\mathrm \hat{I}} x_{\mathrm \hat{I}} \\
%  & + \sum_{ \bar{I} \in I_{\textrm{NLOS}}} \bm{w}_{\mathrm D}^{T} \bm{H}_{\mathrm{RD}} \bm{\Phi} \bm{H}_{\mathrm{ \bar{I} R}}  \bm{w}_{\mathrm \bar{I}} x_{\mathrm \bar{I}} + \tilde{n},
% \end{aligned}
% \end{equation}
