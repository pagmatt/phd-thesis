...
\chapter{Resource management for 5G NR integrated access and backhaul: A semi-centralized approach}
...
%     \input{Figures/CentralResourceManagement/Sim_results/Del_third_quartile_vs_k.tex}
...
%     % this sets the height of the figure, adjust to your needs
%     \setlength\fheight{0.27\columnwidth}
%     \input{Figures/CentralResourceManagement/Sim_results/Del_third_quartile_vs_eta.tex}
...
%     % this sets the height of the figure, adjust to your needs
%     \setlength\fheight{0.27\columnwidth}
%     \input{Figures/CentralResourceManagement/Sim_results/Del_third_quartile_vs_muThreshold.tex}
...
%     % this sets the height of the figure, adjust to your needs
%     \setlength\fheight{0.27\columnwidth}
%     \input{Figures/CentralResourceManagement/Sim_results/Thr_first_quartile_vs_k.tex}
...
%     % this sets the height of the figure, adjust to your needs
%     \setlength\fheight{0.27\columnwidth}
%     \input{Figures/CentralResourceManagement/Sim_results/Thr_first_quartile_vs_eta.tex}
...
%     % this sets the height of the figure, adjust to your needs
%     \setlength\fheight{0.27\columnwidth}
%     \input{Figures/CentralResourceManagement/Sim_results/Thr_first_quartile_vs_muThreshold.tex}
