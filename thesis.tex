...
\begin{filecontents*}[overwrite]{\jobname.xmpdata}
  ...
  \Author{Matteo Pagin}
  \Language{en-GB}
  \Subject{Thesis in partial fulfilment of the requirements for the PhD in Information Engineering of the Department of Information Engineering, University of Padova}
...
\definecolor{UNIPDRED}{RGB}{179,17,28}
...
\addbibresource{Sources/IEEEabrv.bib}
